...
#ifndef HEDGEHOG_TEST_PARTIAL_COMPUTATION_STATE_MANAGER_H
#define HEDGEHOG_TEST_PARTIAL_COMPUTATION_STATE_MANAGER_H
...
#endif //HEDGEHOG_TEST_PARTIAL_COMPUTATION_STATE_MANAGER_H
