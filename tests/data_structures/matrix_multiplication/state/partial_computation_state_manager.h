...
#ifndef HEDGEHOG_PARTIAL_COMPUTATION_STATE_MANAGER_H
#define HEDGEHOG_PARTIAL_COMPUTATION_STATE_MANAGER_H
...
#endif //HEDGEHOG_PARTIAL_COMPUTATION_STATE_MANAGER_H
