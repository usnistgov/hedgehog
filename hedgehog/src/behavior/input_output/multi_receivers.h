...
/// @brief Behavior abstraction for nodes that receive multiple types of data
/// @tparam Inputs Types of data the node receives
template<class ...Inputs>
class MultiReceivers {
 public:
  using inputs_t = std::tuple<Inputs...>; ///< Accessor of input data type
