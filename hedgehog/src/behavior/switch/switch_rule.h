...
#ifndef HEDGEHOG_SWITCH_RULE_H_
#define HEDGEHOG_SWITCH_RULE_H_
...
/// @brief Switch rule behavior abstraction for a type of input
/// @tparam Inputs Type of switch's input
