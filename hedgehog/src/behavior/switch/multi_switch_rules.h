...
/// @brief Switch rules behavior abstraction for different types of input
/// @tparam Inputs Types of switch's input
template <class ...Inputs>
class MultiSwitchRules : public SwitchRule<Inputs>... {
 public:
