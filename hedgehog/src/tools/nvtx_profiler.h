...
///
/// In this mode, hedgehog task uses the single domain to visualize when the task is initializing, executing, waiting for memory,
...
///
/// @note To enable NVTX profiling you must add the HH_USE_NVTX directive.
/// @note Add 'FindNVTX.cmake' to your project to assist in finding the necessary includes and libraries for use with
/// NVTX
class NvtxProfiler {
 private:
#ifdef HH_USE_NVTX
  std::string initializeName_{}; ///< Name for the initialization attribute
  std::string executeName_{}; ///< Name for the execute attribute
  std::string waitName_{}; ///< Name for the wait attribute
  std::string waitForMemName_{}; ///< Name for the wait for memory attribute
  std::string releaseMemName_{}; ///< Name for the release memory attribute
  std::string shutdownName_{}; ///< Name for the shutdown attribute
 ...
 public:
  ...
  /// @brief Adds hedgehog release marker into the timeline to show when the task released memory.
  ...
  /// @brief Ends tracking the initialization phase for hedgehog task
  ...
  /// @brief Ends tracking the execute for hedgehog task
  ...
  /// @brief Ends tracking the waiting for data for hedgehog task
  ...
  /// @brief Ends tracking the waiting for memory from hedgehog memory edge.
  ...
  /// @brief Ends tracking the shutdown phase for hedgehog task
